...
$course=$_POST['course'];
$sem=$_POST['sem'];
$ret=mysqli_query($con,"insert into courseenrolls(studentRegno,pincode,session,department,applyfor,course,semester) values('$studentregno','$pincode','$session','$dept','$applyfor','$course','$sem')");
if($ret)
{
...
{
?>
<option value="<?php echo htmlentities($row['id']);?>"><?php echo htmlentities($row['applyfor']);?></option>
<?php } ?>
...
<div class="form-group">
    ...
    <select multiple = "multiple" class="form-control" name="course"  multiple = "multiple" id="course" onBlur="courseAvailability()" required="required">
