...
$ret=mysqli_query($con,"insert into course(branch,semester,courseCode,courseName,lecture,tutorial,practical) values('$branch','$semester','$coursecode','$coursename','$lecture','$tutorial','$practical')");
if($ret)
{
...
<font color="green" align="center"><?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?></font>
   ...
   <div class="form-group">
    <label for="branch">Branch  </label>
	 <select name="branch" class="form-control" required>
		...
		<option value="Computer Science Integrated">Computer Science Integrated</option>
 ...
 <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="lecture" name="lecture" placeholder="lecture" required />
  </div>  
  
  <div class="form-group">
    <label for="tutorial">Tutorial </label>
    <input type="text" class="form-control" id="tutorial" name="tutorial" placeholder="tutorial" required />
  </div>
  
  <div class="form-group">
    <label for="practical">Practicals </label>
